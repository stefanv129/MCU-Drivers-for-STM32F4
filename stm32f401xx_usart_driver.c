...
void USART_PeriClockControl(USART_RegDef_t *pUSARTx, uint8_t ENorDS)
{
	if(ENorDS == ENABLE)
		{
			if(pUSARTx == USART1)
...
/******************************** Configuration of CR2******************************************/
	...
	tempreg |= pUSARTHandle->USARTConfig.USART_StopBits_NR << USART_CR2_STOP;
...
/******************************** Configuration of CR3******************************************/
	...
	if ( pUSARTHandle->USARTConfig.USART_HW_FlowCtrl == USART_HW_FLOW_CTRL_CTS)
	{
		//Implement the code to enable CTS flow control
		tempreg |= ( 1 << USART_CR3_CTSE);


	}else if (pUSARTHandle->USARTConfig.USART_HW_FlowCtrl == USART_HW_FLOW_CTRL_RTS)
	{
		//Implement the code to enable RTS flow control
		tempreg |= ( 1 << USART_CR3_RTSE);

	}else if (pUSARTHandle->USARTConfig.USART_HW_FlowCtrl == USART_HW_FLOW_CTRL_CTS_RTS)
	{
